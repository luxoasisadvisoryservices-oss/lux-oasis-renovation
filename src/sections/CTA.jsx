    ...
    <section id="contact" className="py-24 md:py-32 bg-stone-900 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <CTAButton href={EMAIL_LINK}>Request a Consultation</CTAButton>
          <CTAButton href={WA_LINK} variant="outlineLight">{WA_ICON} WhatsApp Us</CTAButton>
        </div>
        <div className="mt-14 pt-8 border-t border-stone-800 flex flex-wrap gap-8 justify-center">
          {[
            { label: "Email", value: "info@luxoasisadvisory.com", href: EMAIL_LINK },
            { label: "WhatsApp", value: "Message us directly", href: WA_LINK },
