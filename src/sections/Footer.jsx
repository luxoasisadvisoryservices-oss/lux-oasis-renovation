// ─────────────────────────────────────────────
// Footer.jsx
// Edit: email, WhatsApp, main company URL, legal button triggers
// ─────────────────────────────────────────────
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Services", "Projects", "Process", "Ecosystem", "FAQ", "Contact"].map((link) => (
                <li key={link}>
                  <a href={`#${link.toLowerCase()}`} className="text-stone-500 hover:text-stone-200 text-sm transition-colors">{link}</a>
                </li>
              ))}
            </ul>
          </div>

          {/* Contact — no phone number shown publicly */}
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                <a href="https://wa.me/971585089383" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 text-stone-500 hover:text-amber-400 text-sm transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => openModal("terms-modal")} className="text-stone-500 hover:text-stone-200 text-xs transition-colors">
                  Terms & Conditions
                </button>
              </li>
              <li>
                <button onClick={() => openModal("privacy-modal")} className="text-stone-500 hover:text-stone-200 text-xs transition-colors">
                  Privacy Policy
                </button>
              </li>
            </ul>
